...
This is my take on the Admin Dashboard project of The Odin Project.

### Project Structure
```bash
.
├── assets
│   └── limoncitosketching-cat-4475583.png
├── index.html
├── README.md
└── styles.css
```
...
### Live Page
View it live [here](https://jasonac1.github.io/odin-admin-dashboard/)
